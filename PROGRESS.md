...
| SEC-008 | Endpoint limits and server timeouts | HTTP platform | configuration and slow-client tests | In progress — explicit server timeouts, security headers, auth control-payload limit, and a dedicated 1 MiB import-commit limit landed; large import validation and slow-client integration evidence remain | Pending |
