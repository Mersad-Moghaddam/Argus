...
| 2026-07-28 | 2g | Added viewer-scoped environment listing and editor-scoped creation API routes. Environment base URLs and origins pass through the central backend normalizer before persistence. Focused application and API tests passed. | Complete |
| 2026-07-28 | 2h | The authenticated project view now loads and renders its environment contexts, marking the default and safely showing an unconfigured base URL when appropriate. JavaScript syntax and diff checks passed. | Complete |
