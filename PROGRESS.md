...
| 2026-07-28 | 2g | Added viewer-scoped environment listing and editor-scoped creation API routes. Environment base URLs pass through the central backend normalizer before persistence. Focused application and API tests passed. | Complete |
